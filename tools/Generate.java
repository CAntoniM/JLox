...
public class Generate {
    ...
    private static void defineAst( String outputDir, String baseName, List<String> types) throws IOException {
        ...
        writer.println();
        writer.println("// This file was generated by CAntoniM/JLox/tools/Generator.java");
        writer.println("// if you are making changes to all classes in this file please do via that script");
        writer.println("// otherwise please consider if you need to make the changes at all.");
        writer.println();
        writer.println();
